...
library(kinship2)
library(tidyverse)
setwd("/Users/aja294/Documents/Trout_local/trout-app/Data")
set.seed(101919)

#### Data ####

#read in list of candidates with cols id and sex(male 0, female 1)
candidates = read.table("/Users/aja294/Documents/Trout_local/trout-app/Data/2022_candidates_0924.txt", header = T)
#read in EBV files
