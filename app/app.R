...
ui <- function(request) {
  fluidPage(
    ...
    div(
      ...
      tags$img(src = "allomate.png", height = "200px", style = "margin-left: 20px;"),
      tags$img(src = "logos.png", style = "width: 70%; height: auto;")
    ),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        numericInput("thresh", "Kinship threshold:", value = 1, min = 0, max = 1, step = 0.1),
