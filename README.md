...
AlloMate is developed as part of the [Breeding Insight](https://www.breedinginsight.org) initiative to provide open-source, data-driven tools for modern breeding programs.
```
